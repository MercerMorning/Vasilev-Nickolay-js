...
function collectDOMStat(root) {
  ...
  function collections (element) { 
    for (let elem of element.childNodes) {
      if (elem.nodeType === 3) {
        obj.texts++;
      } else {
        obj.tags.hasOwnProperty(elem.tagName) ? obj.tags[elem.tagName]++ : obj.tags[elem.tagName] = 1;
        for (let classEl of elem.classList) {
          obj.classes.hasOwnProperty(classEl) ? obj.classes[classEl]++ : obj.classes[classEl] = 1;
        }
        collections(elem);
      }
    }
