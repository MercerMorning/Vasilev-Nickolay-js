...
// addListener('click', document.querySelector('a'), someHandler)
...
// delegate(document.body, (e) => console.log('clicked button'))
...
function once(target, fn) {
  target.addEventListener('click', disposable);

    function disposable() {
        fn();
        target.removeEventListener('click', disposable);
    }
}
